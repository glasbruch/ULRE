...
C.city_root_path = 'path/to/your/city_scape'
C.coco_root_path = 'path/to/your/coco'
C.fishy_root_path = 'path/to/your/fishyscapes'
C.segment_me_root_path = 'path/to/your/segment_me'
C.road_anomaly_root_path = 'path/to/your/road_anomaly'
...
C.ood_train_scale_array = [.25, .5, .75, .1, .125]
